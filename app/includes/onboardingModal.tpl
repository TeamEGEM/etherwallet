            ...
            <div class="col-xs-12 col-sm-8 onboarding__content">
              <ul>
                ...
                <li translate="ONBOARD_blockchain_content__5">
                  When you see your balance on MyEgemWallet.com or view your transactions on [explorer.egem.io](https://explorer.egem.io), you are seeing data on the blockchain, not in our personal systems.
                </li>
